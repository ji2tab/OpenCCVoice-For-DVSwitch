...
"""
================================================================================
 DVSwitch ログ監視・自動音声応答システム V1.58
...
# スケジューラー(時報と放送の分離)
# ============================================================
TIME_SIGNAL_LEAD_SEC = 7  # 時報は正時の N 秒前に発火させて、ジャストに音声が始 まるように調整
...
def _log_startup_info():
    """起動時の設定値・環境情報をログ出力"""
    logger.info("=" * 70)
    logger.info(f"DVSwitch Bot V1.58 starting up (PID: {_PID})")
